...
const selfDis=["I once received a friend request from someone claiming to be a former colleague. Despite not recognizing the name, I accepted the request. Over time, I noticed they rarely engaged with my posts and seemed more interested in observing. Later, I learned about online scams involving fake profiles, prompting me to carefully assess the account. I discovered inconsistencies and realized I had accepted a friend request from a fake account. This experience taught me to be cautious when accepting friend requests from unfamiliar accounts.",
"I encountered a troll during a heated online discussion. Instead of engaging with them, I reported their abusive behavior to the platform and focused on positive interactions with others. I adjusted my privacy settings, educated myself about troll tactics, and actively participated in initiatives promoting responsible online behavior. These steps helped me protect myself and contribute to a safer online environment."];
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    setTimeout(()=>{
        ...
        setTimeout(()=>{
            ...
            document.getElementById("self1").style.visibility="visible";
            const s1_length=selfDis[0].split(' ').length;
            setTimeout(()=>{
                document.getElementById("s1").innerHTML=selfDis[0];
        ...
        if(!!answer1){
            ...
            setTimeout(()=>{
                ...
                setTimeout(()=>{
                    ...
                    const s2_length=selfDis[1].split(' ').length;
                        setTimeout(()=>{
                            document.getElementById("s2").innerHTML=selfDis[1];
                            document.getElementById("typing").innerText="Please input your answer";
